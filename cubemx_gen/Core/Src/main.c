...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI_BOSCH_CS_0_Pin|SPI_BOSCH_CS_1_Pin|SPI_BOSCH_CS_2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI_BOSCH_CS_0_Pin SPI_BOSCH_CS_1_Pin SPI_BOSCH_CS_2_Pin */
  GPIO_InitStruct.Pin = SPI_BOSCH_CS_0_Pin|SPI_BOSCH_CS_1_Pin|SPI_BOSCH_CS_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
